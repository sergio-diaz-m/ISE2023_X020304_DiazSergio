...
#define IMAGE_FILE_COUNT 17U

/* Last-Modified: Mon, 13 Feb 2023 16:52:51 GMT */
const uint32_t imageLastModified = 1676307171U;

static const uint8_t imageFileData[24479U] = {
...
static const imageFileItem imageFileTable[17U+1U] = {
  { 0xF8334615U, &imageFileData[0U]     },    // "ad.cgi"
  { 0xB0E380D2U, &imageFileData[2278U]  },    // "ad.cgx"
  { 0xF46138EAU, &imageFileData[2347U]  },    // "buttons.cgi"
  { 0xBCB1FE2DU, &imageFileData[4040U]  },    // "buttons.cgx"
  { 0xDE703953U, &imageFileData[4080U]  },    // "home.png"
  { 0x1B16B2C5U, &imageFileData[5469U]  },    // "index.htm"
  { 0x90CE4E8AU, &imageFileData[7742U]  },    // "keil.gif"
  { 0xD7FABA9AU, &imageFileData[8880U]  },    // "language.cgi"
  { 0x6314E402U, &imageFileData[9784U]  },    // "lcd.cgi"
  { 0xD1C9C758U, &imageFileData[10720U] },    // "leds.cgi"
  { 0x7049A0E1U, &imageFileData[12704U] },    // "llblue.jpg"
  { 0xA35A02C8U, &imageFileData[15712U] },    // "logo.gif"
  { 0xCEC97D75U, &imageFileData[17499U] },    // "network.cgi"
  { 0x3BDBDB05U, &imageFileData[19647U] },    // "pabb.gif"
  { 0x69E9F01DU, &imageFileData[19768U] },    // "system.cgi"
  { 0x5579E5A7U, &imageFileData[21019U] },    // "tcp.cgi"
  { 0xEEA8CB3DU, &imageFileData[21663U] },    // "xml_http.js"
  { 0x00000000U, &imageFileData[24479U] }
};
