...
/* Last-Modified: Tue, 28 Feb 2023 15:19:05 GMT */
const uint32_t imageLastModified = 1677597545U;

static const uint8_t imageFileData[25607U] = {
...
static const imageFileItem imageFileTable[19U+1U] = {
  ...
  { 0xCEC97D75U, &imageFileData[11305U] },    // "network.cgi"
  { 0x69E9F01DU, &imageFileData[13453U] },    // "system.cgi"
  { 0x5579E5A7U, &imageFileData[14704U] },    // "tcp.cgi"
  { 0xEEA8CB3DU, &imageFileData[15348U] },    // "xml_http.js"
  { 0xDE703953U, &imageFileData[18164U] },    // "home.png"
  { 0x90CE4E8AU, &imageFileData[19553U] },    // "keil.gif"
  { 0xA35A02C8U, &imageFileData[20691U] },    // "logo.gif"
  { 0x7049A0E1U, &imageFileData[22478U] },    // "llblue.jpg"
  { 0x3BDBDB05U, &imageFileData[25486U] },    // "pabb.gif"
  { 0x00000000U, &imageFileData[25607U] }
};
